module.exports = function(genericConstants, connection) {
	return  {
		...
		getQuestionForUser: function(userId) {
			var queryString = 'SELECT current_timestamp - t1.timestamp as diftime, t2.difficulty, t1.iq_question_id, l1.link as question, ' +
							  ...
							  '(t1.iq_question_id = t2.iq_question_id) LEFT JOIN '
